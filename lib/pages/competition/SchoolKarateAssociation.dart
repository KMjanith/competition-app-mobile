...
class SchoolKarateAssociation extends StatefulWidget {
  final String HeadingTitle;
  SchoolKarateAssociation({super.key, required this.HeadingTitle});

  @override
  State<SchoolKarateAssociation> createState() =>
      _SchoolKarateAssociationState();
}

class _SchoolKarateAssociationState extends State<SchoolKarateAssociation> {
  void goToPage() {
                  ...
                  children: [
                    ...
                    CreateWhiteButon(
                        callback: () {
                          ...
                          competitionService.createNewGradingPopUp(context);
                        },
