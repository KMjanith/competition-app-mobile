...
class NationalFederation extends StatefulWidget {
  final String headingTitle;
   const NationalFederation({super.key, required this.headingTitle});

  @override
  State<NationalFederation> createState() =>
      _NationalFederationState();
}

class _NationalFederationState extends State<NationalFederation> {
  @override
