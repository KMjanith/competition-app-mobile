...
class Ministry extends StatefulWidget {
  ...
  const Ministry({super.key, required this.headingTitle});
...
class _MinistryState extends State<Ministry> {
  void goToPage(Competition competiton) {
    Navigator.of(context)
        .push(MaterialPageRoute(builder: (context) =>  AddPlayers(competition: competiton)));
  }
                  ...
                  children: [
                    ...
                    CreateWhiteButon(
                        callback: () {
                          ...
                          competitionService.createNewCompetitionPopUp(
                              context, "Ministry");
                        },
